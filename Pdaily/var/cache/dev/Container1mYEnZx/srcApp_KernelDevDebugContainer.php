...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KAYRclUHTW', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-nTUuP7FMa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tzAhuXb28Z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q4F6q4urTU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uyYRTYGQla', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LatfpCdUw4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B7ghqMTM8J', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder3303e = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer3e459 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties32386 = [
        
    ];

    public function getConnection()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getConnection', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getMetadataFactory', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getExpressionBuilder', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'beginTransaction', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getCache', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getCache();
    }

    public function transactional($func)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'transactional', array('func' => $func), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->transactional($func);
    }

    public function commit()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'commit', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->commit();
    }

    public function rollback()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'rollback', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getClassMetadata', array('className' => $className), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'createQuery', array('dql' => $dql), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'createNamedQuery', array('name' => $name), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'createQueryBuilder', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'flush', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'clear', array('entityName' => $entityName), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->clear($entityName);
    }

    public function close()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'close', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->close();
    }

    public function persist($entity)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'persist', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'remove', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'refresh', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'detach', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'merge', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getRepository', array('entityName' => $entityName), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'contains', array('entity' => $entity), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getEventManager', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getConfiguration', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'isOpen', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getUnitOfWork', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getProxyFactory', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'initializeObject', array('obj' => $obj), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'getFilters', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'isFiltersStateClean', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'hasFilters', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return $this->valueHolder3303e->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer3e459 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder3303e) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder3303e = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder3303e->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, '__get', ['name' => $name], $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        if (isset(self::$publicProperties32386[$name])) {
            return $this->valueHolder3303e->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder3303e;
    ...
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;
    ...
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, '__isset', array('name' => $name), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;
    ...
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, '__unset', array('name' => $name), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;
    ...
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, '__clone', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        $this->valueHolder3303e = clone $this->valueHolder3303e;
    }

    public function __sleep()
    {
        $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, '__sleep', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;

        return array('valueHolder3303e');
    }
    ...
    {
        $this->initializer3e459 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer3e459;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer3e459 && ($this->initializer3e459->__invoke($valueHolder3303e, $this, 'initializeProxy', array(), $this->initializer3e459) || 1) && $this->valueHolder3303e = $valueHolder3303e;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder3303e;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder3303e;
    }
